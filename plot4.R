...
par(mfrow = c(2,2))
plot(timeseries, power_condf$Global_active_power, type = "l", xlab = "", ylab = "Golbal Active Power")
plot(timeseries, power_condf$Voltage, type="l", xlab = "datetime", ylab = "Voltage")
plot(timeseries, power_condf$Sub_metering_1, type = "l", xlab = "", ylab = "Energy sub metering")
...
with (power_condf, plot(timeseries, Global_reactive_power, type = "l", xlab = "datetime"))
dev.off()
